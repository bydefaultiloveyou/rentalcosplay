<button
    class="inline-block rounded bg-primary px-12 py-3 text-sm font-medium text-white hover:bg-gray-200 hover:text-black focus:outline-none focus:ring active:text-indigo-500">
